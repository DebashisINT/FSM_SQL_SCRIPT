...
--EXEC PRC_FTSEMPLOYEEPERFORMANCE_REPORT '2024-01-01','2024-04-16','','','',1,'',378
...
29.0	V2.0.44		Debashis	03/01/2023		Performance Summary Report required a new column 'Type' & 'Stage'.Refer: 0027066 & 0027091
30.0	V2.0.46		Debashis	16/04/2024		Separate column is required for Phone number in Performance Summary report.Refer: 0027278
****************************************************************************************************************************************************************************/
BEGIN
	SET NOCOUNT ON
	...
	IF NOT EXISTS (SELECT * FROM sys.objects WHERE OBJECT_ID=OBJECT_ID(N'FTSEMPLOYEEPERFORMANCE_REPORT') AND TYPE IN (N'U'))
		BEGIN
			...
			(
			  ...
			  SHOPADDR NVARCHAR(1000) NULL,
			  SHOPCONTACT NVARCHAR(20) NULL,
			  --End of Rev 30.0
			  --End of Rev 27.0
			  --Rev 18.0
			  ...
			  PPADDR NVARCHAR(500) NULL,
			  PPCONTACT NVARCHAR(20) NULL,
			  --End of Rev 30.0
			  DD_NAME NVARCHAR(300) NULL,
			  --Rev 30.0
			  --DDADDR_CONTACT NVARCHAR(300) NULL,
			  DDADDR NVARCHAR(500) NULL,
			  DDCONTACT NVARCHAR(20) NULL,
			  --End of Rev 30.0
			  --Rev 19.0
	...
	SET @Strsql+='REPORTTO,RPTTODESG,SHOP_TYPE,SHOP_CODE,SHOP_NAME,BEATNAME,ENTITYCODE,SHOPADDR,SHOPCONTACT,SHOP_DISTRICT,SHOP_PINCODE,SHOP_CLUSTER,PP_NAME,PPADDR,PPCONTACT,DD_NAME,DDADDR,DDCONTACT,'
	--End of Rev 30.0
	--Rev 26.0
	...
	SET @Strsql+='ALT_MOBILENO1,SHOP_OWNER_EMAIL2,VISITREMARKS,PARTYSTATUSTYPE,STAGE,MULTI_CONTACT_NAME,MULTI_CONTACT_NUMBER,MEETINGREMARKS,MEETING_ADDRESS,TOTAL_VISIT,NEWSHOP_VISITED,RE_VISITED,TOTMETTING,SPENT_DURATION,'
	SET @Strsql+='DISTANCE_TRAVELLED,'
	--End of Rev 29.0
	--End of Rev 26.0
	--End of Rev 13.0
	...
	--SET @Strsql+='DDADDR_CONTACT,ALT_MOBILENO1,SHOP_OWNER_EMAIL2,VISITREMARKS,PARTYSTATUSTYPE,STAGE,MULTI_CONTACT_NAME,MULTI_CONTACT_NUMBER,MEETINGREMARKS,MEETING_ADDRESS,TOTAL_VISIT,NEWSHOP_VISITED,RE_VISITED,TOTMETTING,'
	----End of Rev 29.0
	----End of Rev 26.0
	----End of Rev 19.0
	----End of Rev 13.0
	...
	SET @Strsql+='DEG_ID,DESIGNATION,DATEOFJOINING,REPORTTO,RPTTODESG,SHOP_TYPE,SHOP_CODE,SHOP_NAME,BEATNAME,ENTITYCODE,SHOPADDR,SHOPCONTACT,SHOP_DISTRICT,SHOP_PINCODE,SHOP_CLUSTER,PP_NAME,'
	SET @Strsql+='PPADDR,PPCONTACT,DD_NAME,DDADDR,DDCONTACT,ALT_MOBILENO1,SHOP_OWNER_EMAIL2,VISITREMARKS,PARTYSTATUSTYPE,STAGE,MULTI_CONTACT_NAME,MULTI_CONTACT_NUMBER,MEETINGREMARKS,'
	SET @Strsql+='MEETING_ADDRESS,TOTAL_VISIT,NEWSHOP_VISITED,RE_VISITED,TOTMETTING,SPENT_DURATION,DISTANCE_TRAVELLED,Total_Order_Booked_Value,Total_Collection FROM('
	--End of Rev 30.0
	--End of Rev 16.0
	--End of Rev 4.0
	--Rev 13.0
	...
	SET @Strsql+='SHOP.Address AS SHOPADDR,SHOP.Shop_Owner_Contact AS SHOPCONTACT,SHOP.CITY_NAME AS SHOP_DISTRICT,SHOP.Pincode AS SHOP_PINCODE,SHOP.CLUSTER AS SHOP_CLUSTER,SHOP.ALT_MOBILENO1,'
	SET @Strsql+='SHOP.SHOP_OWNER_EMAIL2,SHOPPP.Shop_Name AS PP_NAME,SHOPPP.Address AS PPADDR,SHOPPP.Shop_Owner_Contact AS PPCONTACT,'
	--End of Rev 30.0	
	--End of Rev 19.0
	--End of Rev 18.0
	--Rev 13.0
	...
	--Rev 30.0
	--SET @Strsql+='SHOPDD.Shop_Name AS DD_NAME,SHOPDD.Address+'' ''+SHOPDD.Shop_Owner_Contact AS DDADDR_CONTACT,SHOPACT.VISITREMARKS,SHOP.PARTYSTATUSTYPE,SHOP.STAGE,SHOPACT.MULTI_CONTACT_NAME,'
	SET @Strsql+='SHOPDD.Shop_Name AS DD_NAME,SHOPDD.Address AS DDADDR,SHOPDD.Shop_Owner_Contact AS DDCONTACT,SHOPACT.VISITREMARKS,SHOP.PARTYSTATUSTYPE,SHOP.STAGE,SHOPACT.MULTI_CONTACT_NAME,'
	--End of Rev 30.0
	--End of Rev 29.0
	SET @Strsql+='SHOPACT.MULTI_CONTACT_NUMBER,SHOPACT.MEETINGREMARKS,SHOPACT.MEETING_ADDRESS,'
	--End of Rev 26.0
	--End of Rev 13.0
	--End of Rev 1.0
	--Rev 4.0
	...
	--Rev 29.0
	SET @Strsql+='PSTAT.PARTYSTATUS AS PARTYSTATUSTYPE,STG.Stage AS STAGE '
	--End of Rev 29.0
	--End of Rev 25.0
	--End of Rev 9.0
	--End of Rev 8.0
	...
	--End of Rev 25.0
	--Rev 29.0
	SET @Strsql+='LEFT OUTER JOIN FSM_PARTYSTATUS PSTAT ON shop.Party_Status_id=PSTAT.ID '
	SET @Strsql+='LEFT OUTER JOIN FTS_Stage STG ON shop.Stage_id=STG.StageID '
	--End of Rev 29.0
	--Rev 11.0
	...
	--End of Rev 27.0
			...
			SET @Strsql+=''''' AS SHOP_TYPE,'''' AS Shop_Code,'''' AS Shop_Name,'''' AS BEATNAME,'''' AS EntityCode,'''' AS SHOPADDR,'''' AS SHOPCONTACT,'''' AS SHOP_DISTRICT,'''' AS SHOP_PINCODE,'
			SET @Strsql+=''''' AS SHOP_CLUSTER,'''' AS ALT_MOBILENO1,'''' AS Shop_Owner_Email2,'''' AS PP_NAME,'''' AS PPADDR,'''' AS PPCONTACT,'''' AS DD_NAME,'''' AS DDADDR,'''' AS DDCONTACT,'
			--End of Rev 30.0
			--End of Rev 19.0
			--End of Rev 18.0
			--Rev 26.0
			...
			SET @Strsql+=''''' AS MULTI_CONTACT_NAME,'''' AS MULTI_CONTACT_NUMBER,'''' AS VISITREMARKS,'''' AS PARTYSTATUSTYPE,'''' AS STAGE,'''' AS MEETINGREMARKS,'''' AS MEETING_ADDRESS,0 AS TOTAL_VISIT,'
			SET @Strsql+='0 AS NEWSHOP_VISITED,0 AS RE_VISITED,0 AS TOTMETTING,'
			--End of Rev 29.0
			--End of Rev 26.0
			--End of Rev 13.0
			--End of Rev 10.0
