...
--EXEC PRC_FTSEMPLOYEEPERFORMANCE_REPORT '2022-12-01','2023-01-31','','','',1,378
...
BEGIN
	...
	CREATE TABLE #TMPLEAVELOGINOUT(USERID BIGINT,LOGGEDIN NVARCHAR(10),LOGEDOUT NVARCHAR(10),cnt_internalId NVARCHAR(10),Login_datetime NVARCHAR(10),ATTEN_STATUS NVARCHAR(20))
	CREATE NONCLUSTERED INDEX IX1 ON #TMPLEAVELOGINOUT(USERID,cnt_internalId,Login_datetime)

	SET @Strsql=''
	SET @Strsql='INSERT INTO #TMPLEAVELOGINOUT(USERID,LOGGEDIN,LOGEDOUT,cnt_internalId,Login_datetime,ATTEN_STATUS) '
	SET @Strsql+='SELECT ATTEN.User_Id AS USERID,MIN(CONVERT(VARCHAR(5),CAST(ATTEN.Login_datetime AS TIME),108)) AS LOGGEDIN,NULL AS LOGEDOUT,CNT.cnt_internalId,CONVERT(NVARCHAR(10),ATTEN.Work_datetime,105) AS Login_datetime,'
	...
	--Rev 26.0 &&Two new cloumns have been added as MULTI_CONTACT_NAME NVARCHAR(300) & MULTI_CONTACT_NUMBER NVARCHAR(100)
	...
	visited_time VARCHAR(20),VISITREMARKS NVARCHAR(1000),MEETINGREMARKS NVARCHAR(1000),MEETING_ADDRESS NVARCHAR(1000),MULTI_CONTACT_NAME NVARCHAR(300),MULTI_CONTACT_NUMBER NVARCHAR(100))
	...
	--Rev 25.0 && Added a new field as BEATNAME
	SET @Strsql+='REPORTTO,RPTTODESG,SHOP_TYPE,SHOP_CODE,SHOP_NAME,BEATNAME,ENTITYCODE,SHOPADDR_CONTACT,SHOP_DISTRICT,SHOP_PINCODE,SHOP_CLUSTER,PP_NAME,PPADDR_CONTACT,DD_NAME,DDADDR_CONTACT,'
	--Rev 26.0
	--SET @Strsql+='ALT_MOBILENO1,SHOP_OWNER_EMAIL2,VISITREMARKS,MEETINGREMARKS,MEETING_ADDRESS,TOTAL_VISIT,NEWSHOP_VISITED,RE_VISITED,TOTMETTING,SPENT_DURATION,DISTANCE_TRAVELLED,'
	SET @Strsql+='ALT_MOBILENO1,SHOP_OWNER_EMAIL2,VISITREMARKS,MULTI_CONTACT_NAME,MULTI_CONTACT_NUMBER,MEETINGREMARKS,MEETING_ADDRESS,TOTAL_VISIT,NEWSHOP_VISITED,RE_VISITED,TOTMETTING,SPENT_DURATION,DISTANCE_TRAVELLED,'		  
	--End of Rev 26.0
	--End of Rev 13.0
	...
	SET @Strsql+='DEG_ID,DESIGNATION,DATEOFJOINING,REPORTTO,RPTTODESG,SHOP_TYPE,SHOP_CODE,SHOP_NAME,BEATNAME,ENTITYCODE,SHOPADDR_CONTACT,SHOP_DISTRICT,SHOP_PINCODE,SHOP_CLUSTER,PP_NAME,'
	SET @Strsql+='PPADDR_CONTACT,DD_NAME,'
	--End of Rev 25.0
	--Rev 19.0
	...
	SET @Strsql+='DDADDR_CONTACT,ALT_MOBILENO1,SHOP_OWNER_EMAIL2,VISITREMARKS,MULTI_CONTACT_NAME,MULTI_CONTACT_NUMBER,MEETINGREMARKS,MEETING_ADDRESS,TOTAL_VISIT,NEWSHOP_VISITED,RE_VISITED,TOTMETTING,'
	--End of Rev 26.0
	--End of Rev 19.0
	--End of Rev 13.0
	--End of Rev 10.0
	...
	SET @Strsql+='ISNULL(SHOP.SHOP_TYPE,''Meeting'') AS SHOP_TYPE,SHOP.Shop_Code,SHOP.Shop_Name,SHOP.BEATNAME,SHOP.ENTITYCODE,'
	--End of Rev 25.0
	--End of Rev 10.0
	--End of Rev 9.0
	--End of Rev 3.0
	...
	SET @Strsql+='SHOPDD.Shop_Name AS DD_NAME,SHOPDD.Address+'' ''+SHOPDD.Shop_Owner_Contact AS DDADDR_CONTACT,SHOPACT.VISITREMARKS,SHOPACT.MULTI_CONTACT_NAME,SHOPACT.MULTI_CONTACT_NUMBER,SHOPACT.MEETINGREMARKS,'
	SET @Strsql+='SHOPACT.MEETING_ADDRESS,'
	--End of Rev 26.0
	--End of Rev 13.0
	--End of Rev 1.0
	--Rev 4.0
	...
	SET @Strsql+='VISITED_TIME,VISITREMARKS,MEETINGREMARKS,MEETING_ADDRESS,MULTI_CONTACT_NAME,MULTI_CONTACT_NUMBER FROM('
	--End of Rev 26.0
	--Rev 26.0
	...
	SET @Strsql+='SELECT USER_ID,cnt_internalId,Shop_Id,NEWSHOP_VISITED,RE_VISITED,TOTMETTING,SPENT_DURATION,DISTANCE_TRAVELLED,visited_time,VISITREMARKS,MEETINGREMARKS,MEETING_ADDRESS,MULTI_CONTACT_NAME,'
	SET @Strsql+='MULTI_CONTACT_NUMBER FROM #TMPSHOPSUBMITACT '
	SET @Strsql+=') AA GROUP BY User_Id,cnt_internalId,Shop_Id,VISITED_TIME,VISITREMARKS,SPENT_DURATION,MEETINGREMARKS,MEETING_ADDRESS,MULTI_CONTACT_NAME,MULTI_CONTACT_NUMBER '
	--End of Rev 26.0
	...
	--End of Rev 19.0
	--Rev 25.0
	SET @Strsql+='BEAT.NAME AS BEATNAME '
	--End of Rev 25.0
	--End of Rev 9.0
	--End of Rev 8.0
