...
Module	   : Add mutiple contact for a Shop.Refer: Row:783 to 785 and 799 to 801
****************************************************************************************************************************************************************************/
BEGIN
	SET NOCOUNT ON
			...
			BEGIN TRAN
				BEGIN TRY
					...
					AND SHPCON.User_Id=@user_id)
						BEGIN
							INSERT INTO MASTERSHOPMULTICONTACTMAP(USER_ID,SHOP_CODE,CONTACT_SERIAL1,CONTACT_NAME1,CONTACT_NUMBER1,CONTACT_EMAIL1,CONTACT_DOA1,CONTACT_DOB1,CONTACT_SERIAL2,CONTACT_NAME2,
							CONTACT_NUMBER2,CONTACT_EMAIL2,CONTACT_DOA2,CONTACT_DOB2,CONTACT_SERIAL3,CONTACT_NAME3,CONTACT_NUMBER3,CONTACT_EMAIL3,CONTACT_DOA3,CONTACT_DOB3,CONTACT_SERIAL4,CONTACT_NAME4,CONTACT_NUMBER4,
							CONTACT_EMAIL4,CONTACT_DOA4,CONTACT_DOB4,CONTACT_SERIAL5,CONTACT_NAME5,CONTACT_NUMBER5,CONTACT_EMAIL5,CONTACT_DOA5,CONTACT_DOB5,CONTACT_SERIAL6,CONTACT_NAME6,CONTACT_NUMBER6,CONTACT_EMAIL6,
							CONTACT_DOA6,CONTACT_DOB6,CREATED_USER,CREATE_DATE)
							...
							XMLproduct.value('(contact_dob1/text())[1]','DATETIME'),
							...
							XMLproduct.value('(contact_dob2/text())[1]','DATETIME'),
							...
							XMLproduct.value('(contact_dob3/text())[1]','DATETIME'),
							...
							XMLproduct.value('(contact_dob4/text())[1]','DATETIME'),
							...
							XMLproduct.value('(contact_dob5/text())[1]','DATETIME'),
							...
							XMLproduct.value('(contact_dob6/text())[1]','DATETIME'),
							@user_id,GETDATE()
		...
		BEGIN
			...
			AND SHPCON.User_Id=@user_id)
				BEGIN
					...
					CONTACT_DOB1=XMLproduct.value('(contact_dob1/text())[1]','DATETIME'),
					...
					CONTACT_DOB2=XMLproduct.value('(contact_dob2/text())[1]','DATETIME'),
					...
					CONTACT_DOB3=XMLproduct.value('(contact_dob3/text())[1]','DATETIME'),
					...
					CONTACT_DOB4=XMLproduct.value('(contact_dob4/text())[1]','DATETIME'),
					...
					CONTACT_DOB5=XMLproduct.value('(contact_dob5/text())[1]','DATETIME'),
					...
					CONTACT_DOB6=XMLproduct.value('(contact_dob6/text())[1]','DATETIME'),
	...
	IF @ACTION='FETCHDATA'
		BEGIN
			...
			ISNULL(CONTACT_EMAIL1,'') AS contact_email1,CONVERT(NVARCHAR(10),CONTACT_DOA1,105) AS contact_doa1,CONVERT(NVARCHAR(10),CONTACT_DOB1,105) AS contact_dob1,CONTACT_SERIAL2 AS contact_serial2,
			ISNULL(CONTACT_NAME2,'') AS contact_name2,ISNULL(CONTACT_NUMBER2,'') AS contact_number2,ISNULL(CONTACT_EMAIL2,'') AS contact_email2,ISNULL(CONVERT(NVARCHAR(10),CONTACT_DOA2,105),'') AS contact_doa2,
			ISNULL(CONVERT(NVARCHAR(10),CONTACT_DOB2,105),'') AS contact_dob2,CONTACT_SERIAL3 AS contact_serial3,ISNULL(CONTACT_NAME3,'') AS contact_name3,ISNULL(CONTACT_NUMBER3,'') AS contact_number3,
			ISNULL(CONTACT_EMAIL3,'') AS contact_email3,ISNULL(CONVERT(NVARCHAR(10),CONTACT_DOA3,105),'') AS contact_doa3,ISNULL(CONVERT(NVARCHAR(10),CONTACT_DOB3,105),'') AS contact_dob3,CONTACT_SERIAL4 AS contact_serial4,
			ISNULL(CONTACT_NAME4,'') AS contact_name4,ISNULL(CONTACT_NUMBER4,'') AS contact_number4,ISNULL(CONTACT_EMAIL4,'') AS contact_email4,ISNULL(CONVERT(NVARCHAR(10),CONTACT_DOA4,105),'') AS contact_doa4,
			ISNULL(CONVERT(NVARCHAR(10),CONTACT_DOB4,105),'') AS contact_dob4,CONTACT_SERIAL5 AS contact_serial5,ISNULL(CONTACT_NAME5,'') AS contact_name5,ISNULL(CONTACT_NUMBER5,'') AS contact_number5,
			ISNULL(CONTACT_EMAIL5,'') AS contact_email5,ISNULL(CONVERT(NVARCHAR(10),CONTACT_DOA5,105),'') AS contact_doa5,ISNULL(CONVERT(NVARCHAR(10),CONTACT_DOB5,105),'') AS contact_dob5,CONTACT_SERIAL6 AS contact_serial6,
			ISNULL(CONTACT_NAME6,'') AS contact_name6,ISNULL(CONTACT_NUMBER6,'') AS contact_number6,ISNULL(CONTACT_EMAIL6,'') AS contact_email6,ISNULL(CONVERT(NVARCHAR(10),CONTACT_DOA6,105),'') AS contact_doa6,
			ISNULL(CONVERT(NVARCHAR(10),CONTACT_DOB6,105),'') AS contact_dob6 
