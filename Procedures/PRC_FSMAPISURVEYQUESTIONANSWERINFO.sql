...
BEGIN
	...
	IF @ACTION='QUESTIONLIST'
		BEGIN
			...
			QUESTION_FOR_SHOPTYPE_ID AS question_for_shoptype_id,GROUP_NAME AS group_name FROM FSMAPISURVEYQUESTION ORDER BY QUESID
		END
	...
	IF @ACTION='QUESTIONANSWERDETAILLIST'
		BEGIN
			...
			WHERE ANS.USER_ID=@USER_ID AND ANS.SHOP_ID=@SHOP_ID
		END
