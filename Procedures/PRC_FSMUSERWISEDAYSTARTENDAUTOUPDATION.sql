...
BEGIN
	...
	WHILE @@FETCH_STATUS=0
		BEGIN
			...
			IF NOT EXISTS(SELECT ISEND FROM FSMUSERWISEDAYSTARTEND WHERE USER_ID=@USER_ID AND CAST(STARTENDDATE AS date)=@STARTENDDATE AND ISEND IN(0,1) AND REMARKS IN('Auto Update Cutoff Time'))
			--End of Rev 2.0
				BEGIN
