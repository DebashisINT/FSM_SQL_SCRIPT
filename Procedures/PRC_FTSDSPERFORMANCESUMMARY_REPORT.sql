--EXEC PRC_FTSDSPERFORMANCESUMMARY_REPORT '2023-07-01','2023-08-30','','',378
...
BEGIN
	...
	SET @SqlStr+='AVGTIMESPENTINMARKET,AVGSPENTDURATION,SALE_VALUE,OUTLETEMPSEX,GENDERDESC)'
	...
	SET @SqlStr+='THEN 1 ELSE 0 END AS QUALIFYATTENDANCE,SPENT_DURATION,DAYSTARTEND.SALE_VALUE,DAYSTARTEND.VISITDDID,CNT.cnt_sex AS OUTLETEMPSEX,CNT.GENDERDESC '
