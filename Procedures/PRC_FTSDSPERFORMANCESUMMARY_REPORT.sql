...
BEGIN
	...
	SET @SqlStr+='AVGTIMESPENTINMARKET,AVGSPENTDURATION,SALE_VALUE,ORDER_VALUE,OUTLETEMPSEX,GENDERDESC)'
	...
	SET @SqlStr+='THEN 1 ELSE 0 END AS QUALIFYATTENDANCE,SPENT_DURATION,DAYSTARTEND.SALE_VALUE,ORD.ORDER_VALUE,DAYSTARTEND.VISITDDID,CNT.cnt_sex AS OUTLETEMPSEX,CNT.GENDERDESC '
