...
BEGIN
	...
	--Rev Debashis && A new column has been added as WORKACTIVITYDESCRIPTION NVARCHAR(500)
	...
	SET @SqlStr=''
	--Rev Debashis && A new column has been added as WORKACTIVITYDESCRIPTION
	...
	IF NOT EXISTS (SELECT * FROM sys.objects WHERE OBJECT_ID=OBJECT_ID(N'FTSDSPERFORMANCESUMMARY_REPORT') AND TYPE IN (N'U'))
		BEGIN
			...
			--Rev Debashis && A new column has been added as TOTALCDMDAYS INT
	...
	--Rev 4.0 && Two new fields added as OUTLETEMPSEX & GENDERDESC
	--Rev 7.0 && A new cloumn has been added as ORDER_VALUE
	--Rev Debashis && A new column has been added as TOTALCDMDAYS
	SET @SqlStr=''
