...
BEGIN
	...
	--End of Rev 6.0
			...
			SET @SqlStr+='DAYSTTIME,DAYENDTIME,SALE_VALUE,ORDER_VALUE,AVGSPENTDURATION,DSTYPEID,DSTYPE,CIRCLE,ATTENDANCE,QUALIFIEDPRESENT,OUTLETEMPSEX,GENDERDESC) '
			--End of Rev 6.0
			--End of Rev 4.0
			--Rev 5.0
			...
			--Rev 6.0
			--SET @SqlStr+='DSTYPEID,DSTYPE,CIRCLE '
			SET @SqlStr+='SUM(SALE_VALUE) AS SALE_VALUE,SUM(ORDER_VALUE) AS ORDER_VALUE,DSTYPEID,DSTYPE,CIRCLE,SUM(ATTENDANCE) AS ATTENDANCE,SUM(QUALIFIEDPRESENT) AS QUALIFIEDPRESENT,OUTLETEMPSEX,GENDERDESC '
			--End of Rev 6.0
			--End of Rev 4.0
			SET @SqlStr+='FROM('
			--Rev 5.0
