...
BEGIN
	...
	--End of Rev 6.0
			...
			(USERID BIGINT,DAYSTTIME NVARCHAR(10),DAYENDTIME NVARCHAR(10),STARTENDDATE NVARCHAR(10),SALE_VALUE NUMERIC(18,2),STARTENDDATEORDBY NVARCHAR(10))
			...
			SET @SqlStr='INSERT INTO #TMPDAYSTARTEND(USERID,DAYSTTIME,DAYENDTIME,STARTENDDATE,SALE_VALUE,STARTENDDATEORDBY) '
	...
	--End of Rev 6.0
			...
			SET @SqlStr+='DAYSTTIME,DAYENDTIME,SALE_VALUE,AVGSPENTDURATION,DSTYPEID,DSTYPE,CIRCLE,ATTENDANCE,QUALIFIEDPRESENT,OUTLETEMPSEX,GENDERDESC) '
			--End of Rev 6.0
			--End of Rev 4.0
			--Rev 5.0
			...
			SET @SqlStr+='DAYSTTIME,DAYENDTIME,SALE_VALUE,'
			...
			--Rev 6.0
			--SET @SqlStr+='DSTYPEID,DSTYPE,CIRCLE '
			SET @SqlStr+='SUM(SALE_VALUE) AS SALE_VALUE,DSTYPEID,DSTYPE,CIRCLE,SUM(ATTENDANCE) AS ATTENDANCE,SUM(QUALIFIEDPRESENT) AS QUALIFIEDPRESENT,OUTLETEMPSEX,GENDERDESC '
			--End of Rev 6.0
			--End of Rev 4.0
			SET @SqlStr+='FROM('
			--Rev 5.0
			...
			SET @SqlStr+='ISNULL(DISTANCE_TRAVELLED,0) AS DISTANCE_TRAVELLED,DAYSTARTEND.DAYSTTIME,DAYSTARTEND.DAYENDTIME,DAYSTARTEND.SALE_VALUE,'
			...
			SET @SqlStr+='INNER JOIN ('
			SET @SqlStr+='SELECT USERID,MIN(DAYSTTIME) AS DAYSTTIME,MAX(DAYENDTIME) AS DAYENDTIME,STARTENDDATE,SUM(SALE_VALUE) AS SALE_VALUE,STARTENDDATEORDBY FROM('
			SET @SqlStr+='SELECT USERID,DAYSTTIME,DAYENDTIME,STARTENDDATE,SALE_VALUE,STARTENDDATEORDBY FROM #TMPDAYSTARTEND '
