...
BEGIN
	...
	IF @ACTION='INSERTAADHARINFO'
		BEGIN
			...
			IF NOT EXISTS(SELECT USER_ID FROM FSMUSERAADHARIMAGEDETECTION WHERE NAMEONAADHAR=@NAMEONAADHAR AND AADHARDOB=@AADHARDOB)
			--End of Rev 1.0
				BEGIN
			...
			IF EXISTS(SELECT USER_ID FROM FSMUSERAADHARIMAGEDETECTION WHERE NAMEONAADHAR=@NAMEONAADHAR AND AADHARDOB=@AADHARDOB)			
				SELECT USER_ID,NAMEONAADHAR,AADHAAR_NO,'Duplicate' AS STRMESSAGE FROM FSMUSERAADHARIMAGEDETECTION WHERE NAMEONAADHAR=@NAMEONAADHAR AND AADHARDOB=@AADHARDOB
			--End of Rev 1.0
		END
