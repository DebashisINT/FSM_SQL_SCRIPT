...
BEGIN
	...
	DECLARE @TARGETLEVELID bigint=0,@TARGETLEVEL nvarchar(200)='',@TARGETLEVELNAME nvarchar(200)='',@TARGETLEVELCODE nvarchar(200)='' ,@TIMEFRAME nvarchar(200)='' ,@STARTEDATE datetime,@ENDDATE datetime
	...
	BEGIN
			...
			BEGIN 
				...
				Begin
						...
						INSERT INTO IMPORT_TARGET_LOG(IMPORT_TARGET_ID,
						DocumentNo,DocumentDate,
						EmployeeGroup,TargetFor,TARGETLEVELNAME,TARGETLEVELCODE,TIMEFRAME,STARTDATE,ENDDATE,NEWVISIT,REVISIT,ORDERAMOUNT,ORDERQTY,BRANDNAME,ImportStatus,ImportMsg,CREATEDBY,CREATEDON
						)
						Select @LastCountIMPORTLOG+1,@TargetNo,@TargetDate
							,@EmployeeGroup,@TargetFor
						,@TARGETLEVELNAME,@TARGETLEVELCODE,@TIMEFRAME,@STARTEDATE
						,@ENDDATE,@NEWVISIT,@REVISIT,@ORDERAMOUNT,@BRANDNAME,@ORDERQTY,'Failed','Duplicate Document Number.',@USER_ID,GETDATE()
