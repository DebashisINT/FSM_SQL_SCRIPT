		...
		BEGIN
			...
			BEGIN
				...
				BEGIN 
					...
					if NOT EXISTS (select 'Y' from FSM_SALESTARGETASSIGN_DETAILS   where TARGETLEVELASSIGNID=@TARGETLEVELID and TARGETLEVELASSIGNNAME=@TARGETLEVEL and 	INTERNALID=@INTERNALID and TIMEFRAME=@TIMEFRAME
					and STARTDATE=@STARTEDATE and ENDDATE=@ENDDATE )
					Begin
