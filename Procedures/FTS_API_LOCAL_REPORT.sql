...
---------------------------------DESIGNATION-------------------------------------
	...
	SET @Strsql='INSERT INTO FTSLOCATION_REPORT(LOGIN_ID,SEQ,State_name,Designation,Employee_Name,VISITFROMDATE,VISITTODATE,TOTAL_HRS_WORKED,LOCATION,SHOP_NAME,ENTITYCODE,SHOP_OWNER_NAME,SHOP_OWNER_CONTACT,'
	SET @Strsql+='SHOP_TYPE,ADDRESS,USER_ID,NOOFDATEVISIT) '
	--End of Rev 2.0
	...
	SET @Strsql+='T.location_name,T.Shop_Name,T.ENTITYCODE,T.Shop_Owner,T.Shop_Owner_Contact,T.Name,T.Address,T.user_id,T.CNT FROM '
	--End of Rev 2.0
	SET @Strsql+='('
	--Rev 2.0
	...
	SET @Strsql+='SELECT SHP.Shop_Name,SHP.ENTITYCODE,SHP.Address,LOC.location_name,SHP.Shop_Owner,SHP.Shop_Owner_Contact,CNT.cnt_firstName+'' ''+CNT.cnt_middleName+'' ''+CNT.cnt_lastName AS user_name,'
	--End of Rev 2.0
	...
	SET @Strsql+='GROUP BY SHP.Shop_Name,SHP.ENTITYCODE,SHP.Address,LOC.location_name,SHP.Shop_Owner,SHP.Shop_Owner_Contact,CNT.cnt_firstName,CNT.cnt_middleName,CNT.cnt_lastName,N.DES_NAME,STAT.STATE_NAME,STYP.Name,'
	--End of Rev 2.0
