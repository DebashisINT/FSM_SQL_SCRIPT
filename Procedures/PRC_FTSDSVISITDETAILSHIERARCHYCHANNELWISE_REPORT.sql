--EXEC PRC_FTSDSVISITDETAILSHIERARCHYCHANNELWISE_REPORT '2022-10-01','2022-10-31','','','',54685
...
BEGIN
	...
	SET @SqlStr+='DISTANCE_TRAVELLED,AVGTIMESPENTINMARKET,DAYSTTIME,DAYENDTIME,AVGSPENTDURATION,DSTYPEID,DSTYPE,CIRCLE,SECTION,CH_ID,CHANNEL) '
	...
	SET @SqlStr+='DSTYPEID,DSTYPE,CIRCLE,SECTION,CH_ID,CHANNEL '
	SET @SqlStr+='FROM('
	...
	SET @SqlStr+=') AS CIR FOR XML PATH(''''))),1,2,'' ''))),'''') AS CIRCLE,CH.CH_ID,CH.CHANNEL '
	...
	SET @SqlStr+=') DSDET '
	SET @SqlStr+='GROUP BY LOGINDATE,LOGIN_DATETIME,BRANCH_ID,BRANCH_DESCRIPTION,EMPUSERID,EMPCODE,EMPID,EMPNAME,STATEID,STATE,DEG_ID,DESIGNATION,DATEOFJOINING,CONTACTNO,REPORTTOIDWD,REPORTTOUIDWD,REPORTTOWD,'
	SET @SqlStr+='RPTTODESGWD,REPORTTOIDAE,REPORTTOUIDAE,REPORTTOAE,RPTTODESGAE,DAYSTTIME,DAYENDTIME,'
	SET @SqlStr+='DSTYPEID,DSTYPE,CIRCLE,SECTION,CH_ID,CHANNEL '
