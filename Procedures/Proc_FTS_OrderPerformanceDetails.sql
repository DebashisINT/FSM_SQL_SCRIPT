...
ALTER PROCEDURE [dbo].[Proc_FTS_OrderPerformanceDetails]
(
...
BEGIN
	...
	SET @SQL='SELECT Order_ProdId,Product_Id,Product_Qty,Product_Rate,Product_Price,ordprod.Shop_code,'
	--Rev 1.0
	...
	SET @SQL+='mprod.sProducts_Name,Order_ID,shp.Shop_Name,shp.ENTITYCODE,brnd.Brand_Name,clss.ProductClass_Name as Category,msize.Size_Name as Strength,'
	--End of Rev 1.0
