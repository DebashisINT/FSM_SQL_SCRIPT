...
--EXEC PROC_EMPOUTLETMAPPDASHBOARDDATEWISE '19','2023-11-21',378

IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[PROC_EMPOUTLETMAPPDASHBOARDDATEWISE]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [PROC_EMPOUTLETMAPPDASHBOARDDATEWISE] AS' 
END
GO

ALTER PROCEDURE [dbo].[PROC_EMPOUTLETMAPPDASHBOARDDATEWISE]
(
...
AS
/****************************************************************************************************************************************************************************
PROCEDURE WRITTEN BY PRITI ON 25/08/2023 FOR v2.0.42 AND MANTIS 0026757:On demand loading of employee name is required in View Route (Dashboard).
