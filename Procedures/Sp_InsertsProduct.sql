...
--Insert into packingDetails table 
	...
	BEGIN
		DELETE FROM FSMProduct_Master WHERE sProducts_ID=@prodId
		
		insert into FSMProduct_Master
		SELECT @ProductCreateUser ,MP.sProducts_ID ,MP.sProducts_Code ,MP.sProducts_Name ,MP.sProducts_Description ,MP.sProducts_Type ,
