--EXEC PRC_FTSORDERWITHPRODUCTATTRIBUTE_REPORT '2020-06-01','2021-10-31','','','',378
...
BEGIN
	...
	SET @Strsql+='SHOP_TYPE,SHOP_CODE,SHOP_NAME,SHOPADDRESS,SHOP_CONTACT,PP_NAME,PPADDR_CONTACT,DD_NAME,DDADDR_CONTACT,ORDER_DATE,ORDER_NO,GENDER,PRODUCT_NAME,COLORRID,COLOR_NAME,SIZE,QUANTITY) '
	...
	SET @Strsql+='COLOR_NAME,SIZE,QTY FROM('
	...
	SET @Strsql+='ORDHEAD.SIZE,ORDHEAD.QTY '
	...
	SET @Strsql+='WHEN ORDD.GENDER=''Women'' THEN ''Women'' END AS GENDER,ORDD.PRODUCT_ID,ORDD.PRODUCT_NAME,MC.COLOR_NAME,ORDD.SIZE,ORDD.QTY '
