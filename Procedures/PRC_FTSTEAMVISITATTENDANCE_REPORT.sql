...
BEGIN
	...
	CREATE TABLE #TMPATTENDACE(LOGIN_DATE NVARCHAR(10),BRANCH_ID BIGINT,BRANCH_DESCRIPTION NVARCHAR(300),USERID BIGINT,EMPCODE NVARCHAR(100),EMPID NVARCHAR(100),EMPNAME NVARCHAR(300),DSTLTYPE NVARCHAR(300),
	STATEID BIGINT,STATE NVARCHAR(100),DEG_ID BIGINT,DESIGNATION NVARCHAR(300),DATEOFJOINING NVARCHAR(10),CONTACTNO NVARCHAR(100),CH_ID BIGINT,CHANNEL NVARCHAR(100),PRESENTABSENT INT,REPORTTOID NVARCHAR(100),
	...
	CREATE TABLE #TMPATTENDACEDET(LOGIN_DATE NVARCHAR(10),BRANCH_ID BIGINT,BRANCH_DESCRIPTION NVARCHAR(300),USERID BIGINT,EMPCODE NVARCHAR(100),EMPID NVARCHAR(100),EMPNAME NVARCHAR(300),DSTLTYPE NVARCHAR(300),
	STATEID BIGINT,STATE NVARCHAR(100),DEG_ID BIGINT,DESIGNATION NVARCHAR(300),DATEOFJOINING NVARCHAR(10),CONTACTNO NVARCHAR(100),CH_ID BIGINT,CHANNEL NVARCHAR(100),PRESENTABSENT INT,REPORTTOID NVARCHAR(100),
	REPORTTOUID NVARCHAR(100),REPORTTO NVARCHAR(300),RPTTODESG NVARCHAR(100),SECTION NVARCHAR(MAX),CIRCLE NVARCHAR(MAX))
		...
		BEGIN
			WHILE @LOOPCOUNT<=@DAYCOUNT
				BEGIN				
					...
					INSERT INTO #TMPATTENDACE(LOGIN_DATE,BRANCH_ID,BRANCH_DESCRIPTION,USERID,EMPCODE,EMPID,EMPNAME,DSTLTYPE,STATEID,STATE,DEG_ID,DESIGNATION,DATEOFJOINING,CONTACTNO,CH_ID,CHANNEL,
					PRESENTABSENT,REPORTTOID,REPORTTOUID,REPORTTO,RPTTODESG,SECTION,CIRCLE)
					...
					PRESENTABSENT,REPORTTOID,REPORTTOUID,REPORTTO,RPTTODESG,SECTION,CIRCLE FROM #TMPATTENDACEDET WHERE LOGIN_DATE BETWEEN @COLUMN_DATE AND @TODATE
