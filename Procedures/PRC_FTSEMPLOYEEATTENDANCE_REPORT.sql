--EXEC PRC_FTSEMPLOYEEATTENDANCE_REPORT '2021-11-14','2021-11-16','1','',378
...
BEGIN
	...
	DEG_ID BIGINT,DESIGNATION NVARCHAR(300),DATEOFJOINING NVARCHAR(10),CONTACTNO NVARCHAR(100),REPORTTOID NVARCHAR(100),REPORTTO NVARCHAR(300),RPTTODESG NVARCHAR(100),HREPORTTOID NVARCHAR(100),
	HREPORTTO NVARCHAR(300),HRPTTODESG NVARCHAR(100))
	...
	REPORTTO NVARCHAR(300),RPTTODESG NVARCHAR(100),HREPORTTOID NVARCHAR(100),HREPORTTO NVARCHAR(300),HRPTTODESG NVARCHAR(100))
				...
				BEGIN				
					...
					IF @FIRSTTIME=1
						BEGIN
							...
							SET @SqlStrTable+='REPORTTOID,REPORTTO,RPTTODESG,HREPORTTOID,HREPORTTO,HRPTTODESG,'
							...
							SET @SqlStrTable+=') '
							SET @SqlStrTable+='SELECT BRANCH_ID,BRANCH_DESCRIPTION,USERID,EMPCODE,EMPID,EMPNAME,STATEID,STATE,DEG_ID,DESIGNATION,DATEOFJOINING,CONTACTNO,REPORTTOID,REPORTTO,RPTTODESG,'
							SET @SqlStrTable+='HREPORTTOID,HREPORTTO,HRPTTODESG,LOGGEDIN,LOGEDOUT,DAYSTTIME,DAYENDTIME '
