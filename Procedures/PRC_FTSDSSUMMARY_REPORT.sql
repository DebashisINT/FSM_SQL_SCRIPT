--EXEC PRC_FTSDSSUMMARY_REPORT '2023-01-01','2023-08-28','','',378
...
BEGIN
	...
	SET @SqlStr+='SUM(DISTINCT OUTLETSMAPPED) AS OUTLETSMAPPED,SUM(NEWSHOP_VISITED) AS NEWSHOP_VISITED,SUM(RE_VISITED) AS RE_VISITED,SUM(TOTAL_VISIT) AS TOTAL_VISIT,SUM(DISTANCE_TRAVELLED) AS DISTANCE_TRAVELLED,'
	--End of Rev 6.0
