--EXEC PRC_FTSDSSUMMARY_REPORT '2021-11-01','2021-11-30','1','',378
...
BEGIN
	...
	SET @SqlStr=''
	SET @SqlStr='INSERT INTO FTSDSSUMMARY_REPORT(USERID,SEQ,BRANCH_ID,BRANCHDESC,EMPCODE,EMPID,EMPNAME,STATEID,STATE,DEG_ID,DESIGNATION,DATEOFJOINING,CONTACTNO,REPORTTOID,REPORTTO,RPTTODESG,HREPORTTOID,'
	SET @SqlStr+='HREPORTTO,HRPTTODESG,DATERANGE,NEWSHOP_VISITED,RE_VISITED,TOTAL_VISIT,DISTANCE_TRAVELLED,AVGTIMESPENTINMARKET,AVGSPENTDURATION)'
	...
	SET @SqlStr+='NEWSHOP_VISITED,RE_VISITED,TOTAL_VISIT,DISTANCE_TRAVELLED,'
	...
	SET @SqlStr+='FROM('
	SET @SqlStr+='SELECT BRANCH_ID,BRANCH_DESCRIPTION,USERID,EMPCODE,EMPID,EMPNAME,STATEID,STATE,DEG_ID,DESIGNATION,DATEOFJOINING,CONTACTNO,REPORTTOID,REPORTTO,RPTTODESG,HREPORTTOID,HREPORTTO,HRPTTODESG,'
