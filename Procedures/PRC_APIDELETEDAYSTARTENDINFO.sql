	...
	IF @ACTION='DELETEDAYSTARTENDATTENDANCE'
		BEGIN
			IF @ISDAYSTARTDEL='1' AND @ISDAYENDDEL='0'
				BEGIN
					IF EXISTS(SELECT User_Id FROM FSMUSERWISEDAYSTARTEND WITH(NOLOCK) WHERE User_Id=@USER_ID AND CAST(STARTENDDATE AS DATE)=CAST(@DATE AS DATE) AND ISSTART=CAST(@ISDAYSTARTDEL AS BIT))
						BEGIN
							SELECT User_Id FROM FSMUSERWISEDAYSTARTEND WITH(NOLOCK) WHERE User_Id=@USER_ID AND CAST(STARTENDDATE AS DATE)=CAST(@DATE AS DATE) AND ISSTART=CAST(@ISDAYSTARTDEL AS BIT)
			...
			ELSE IF @ISDAYSTARTDEL='0' AND @ISDAYENDDEL='1'
				BEGIN
					IF EXISTS(SELECT User_Id FROM FSMUSERWISEDAYSTARTEND WITH(NOLOCK) WHERE User_Id=@USER_ID AND CAST(STARTENDDATE AS DATE)=CAST(@DATE AS DATE) AND ISEND=CAST(@ISDAYENDDEL AS BIT))
						BEGIN
							SELECT User_Id FROM FSMUSERWISEDAYSTARTEND WITH(NOLOCK) WHERE User_Id=@USER_ID AND CAST(STARTENDDATE AS DATE)=CAST(@DATE AS DATE) AND ISEND=CAST(@ISDAYENDDEL AS BIT)
			...
			ELSE IF @ISDAYSTARTDEL='1' AND @ISDAYENDDEL='1'
				BEGIN
					IF EXISTS(SELECT User_Id FROM FSMUSERWISEDAYSTARTEND WITH(NOLOCK) WHERE User_Id=@USER_ID AND CAST(STARTENDDATE AS DATE)=CAST(@DATE AS DATE) 
					AND (ISSTART=CAST(@ISDAYSTARTDEL AS BIT) OR ISEND=CAST(@ISDAYENDDEL AS BIT)))
						BEGIN
							SELECT User_Id FROM FSMUSERWISEDAYSTARTEND WITH(NOLOCK) WHERE User_Id=@USER_ID AND CAST(STARTENDDATE AS DATE)=CAST(@DATE AS DATE) 
							AND (ISSTART=CAST(@ISDAYSTARTDEL AS BIT) OR ISEND=CAST(@ISDAYENDDEL AS BIT))
