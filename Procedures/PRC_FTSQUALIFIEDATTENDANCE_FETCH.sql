...
BEGIN
	...
	WORKACTIVITYDESCRIPTION NVARCHAR(500))
	CREATE NONCLUSTERED INDEX IX1 ON #TMPDAYSTARTENDQA(USERID,STARTENDDATE)

	SET @SqlStr=''
	SET @SqlStr='INSERT INTO #TMPDAYSTARTENDQA(USERID,DAYSTTIME,DAYENDTIME,cnt_internalId,STARTENDDATE,STARTENDDATEORDBY,WORKACTIVITYDESCRIPTION) '
	...
	SET @SqlStr+='CONVERT(NVARCHAR(10),DAYSTEND.STARTENDDATE,105) AS STARTENDDATE,CONVERT(NVARCHAR(10),DAYSTEND.STARTENDDATE,120) AS STARTENDDATEORDBY,WORKACTIVITYDESCRIPTION '
