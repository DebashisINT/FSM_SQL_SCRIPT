...
BEGIN
	...
	SET @SqlStr=''
	SET @SqlStr='INSERT INTO #TMPDAYSTARTENDQA(USERID,DAYSTTIME,DAYENDTIME,cnt_internalId,STARTENDDATE) '
	...
	SET @SqlStr+='GROUP BY DAYSTEND.User_Id,CNT.cnt_internalId,CONVERT(NVARCHAR(10),DAYSTEND.STARTENDDATE,105) '
	...
	SET @SqlStr=''
	SET @SqlStr+='SELECT DAYSTARTEND.STARTENDDATE,BR.BRANCH_ID,BR.BRANCH_DESCRIPTION,USR.USER_ID AS USERID,CNT.cnt_internalId AS EMPCODE,EMP.emp_uniqueCode AS EMPID,'
	...
	SET @SqlStr+='SELECT USERID,DAYSTTIME,DAYENDTIME,cnt_internalId,STARTENDDATE FROM #TMPDAYSTARTENDQA '
