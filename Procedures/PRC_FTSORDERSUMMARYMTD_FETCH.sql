--EXEC PRC_FTSORDERSUMMARYMTD_FETCH 'JUL','2023','','','EMC0000001',378

IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[PRC_FTSORDERSUMMARYMTD_FETCH]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [PRC_FTSORDERSUMMARYMTD_FETCH] AS' 
END
GO

ALTER PROCEDURE [dbo].[PRC_FTSORDERSUMMARYMTD_FETCH]
(
...
Module	   : Order Month to Date.Refer: 0026429
****************************************************************************************************************************************************************************/
BEGIN
	SET NOCOUNT ON
