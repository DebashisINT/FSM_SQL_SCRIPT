...
BEGIN
	...
	SET @Strsql+='SUM(TOTALORDERVALUE) AS TOTALORDERVALUE,SUM(DISTINCT TOTALORDVALWITHOUTVISIT) AS TOTALORDVALWITHOUTVISIT,SUM(DISTINCT TARGETORDVALUE) AS TARGETORDVALUE,CASE WHEN SUM(ORDSHPCNT)<> 0 THEN '
