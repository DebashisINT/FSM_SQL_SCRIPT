...
BEGIN
	...
	begin
		...
		Begin
			...
			Union All
			SELECT Replace(EnquiryFromDesc,' ','') as EnquiryFromDescValue, EnquiryFromDesc from tbl_master_EnquiryFrom where EnquiryFromDesc NOT IN ('Other','IndiaMart','IndiaMart (ARCHER)','MccoyMart')
			Union All
		...
		Begin
			SELECT 'Select' as EnquiryFromDescValue,'Select' as EnquiryFromDesc
			Union All
			SELECT Replace(EnquiryFromDesc,' ','') as EnquiryFromDescValue, EnquiryFromDesc from tbl_master_EnquiryFrom where EnquiryFromDesc NOT IN ('Other','IndiaMart','IndiaMart (ARCHER)')
			Union All
			SELECT EnquiryFromDesc as EnquiryFromDescValue, EnquiryFromDesc from tbl_master_EnquiryFrom  where EnquiryFromDesc='Other' 
		End
