...
@QUOTATION_CONTACT_PERSON NVARCHAR(300)=NULL,
@QUOTATION_CONTACT_NUMBER NVARCHAR(100)=NULL,
@QUOTATION_CONTACT_EMAIL NVARCHAR(500)=NULL,
@QUOTATION_CONTACT_DOA DATETIME=NULL,
--End of Rev 3.0
@JsonXML XML=NULL
) --WITH ENCRYPTION
AS
...
3.0		v2.0.37		Debashis	10/01/2023		Some new fields added as SEL_QUOTATION_PDF_TEMPLATE,QUOTATION_CONTACT_PERSON,QUOTATION_CONTACT_NUMBER,QUOTATION_CONTACT_EMAIL,QUOTATION_CONTACT_DOA & 
												sProducts_Description.Row: 790 to 791
...
BEGIN
						...
						BEGIN TRY
							IF NOT EXISTS(SELECT QUOTATION_NUMBER FROM FSMAPIQUOTATIONHEAD WHERE QUOTATION_NUMBER=@QUOTATION_NUMBER)
								BEGIN
									...
									--Rev 3.0 && Some new fields added as SEL_QUOTATION_PDF_TEMPLATE,QUOTATION_CONTACT_PERSON,QUOTATION_CONTACT_NUMBER,QUOTATION_CONTACT_EMAIL & QUOTATION_CONTACT_DOA
									...
									CREATED_DATE,REMARKS,DOCUMENT_NUMBER,QUOTATION_STATUS,SEL_QUOTATION_PDF_TEMPLATE,QUOTATION_CONTACT_PERSON,QUOTATION_CONTACT_NUMBER,QUOTATION_CONTACT_EMAIL,QUOTATION_CONTACT_DOA)
									...
									@USER_ID,GETDATE(),@REMARKS,@DOCUMENT_NUMBER,@QUOTATION_STATUS,@SEL_QUOTATION_PDF_TEMPLATE,@QUOTATION_CONTACT_PERSON,@QUOTATION_CONTACT_NUMBER,@QUOTATION_CONTACT_EMAIL,@QUOTATION_CONTACT_DOA
	...
	ELSE IF @ACTION='SHOWQUOTATIONDETAILS'
		BEGIN
			...
			--Rev 3.0 && Some new fields added as SEL_QUOTATION_PDF_TEMPLATE,QUOTATION_CONTACT_PERSON,QUOTATION_CONTACT_NUMBER,QUOTATION_CONTACT_EMAIL,QUOTATION_CONTACT_DOA & sProducts_Description
			...
			MS.Pincode AS shop_address_pincode,QH.SEL_QUOTATION_PDF_TEMPLATE AS sel_quotation_pdf_template,QH.QUOTATION_CONTACT_PERSON AS quotation_contact_person,QH.QUOTATION_CONTACT_NUMBER AS quotation_contact_number,
			QH.QUOTATION_CONTACT_EMAIL AS quotation_contact_email,QH.QUOTATION_CONTACT_DOA AS quotation_contact_doa,QHD.PROD_ID AS product_id,MP.sProducts_Name AS product_name,MP.sProducts_Description AS product_des,
					...
					BEGIN TRAN
						BEGIN TRY
							IF NOT EXISTS(SELECT DOCUMENT_NUMBER FROM FSMAPIQUOTATIONHEAD WHERE DOCUMENT_NUMBER=@DOCUMENT_NUMBER)
								BEGIN
									--Rev 4.0 && Some new fields added as SEL_QUOTATION_PDF_TEMPLATE,QUOTATION_CONTACT_PERSON,QUOTATION_CONTACT_NUMBER,QUOTATION_CONTACT_EMAIL & QUOTATION_CONTACT_DOA
									INSERT INTO FSMAPIQUOTATIONHEAD(USER_ID,QUOTATION_NUMBER,QUOTATIONSAVE_DATE,QUOTATION_DATE_SELECTION,PROJECT_NAME,TAXES,FREIGHT,DELIVERY_TIME,PAYMENT,VALIDITY,BILLING,
									PRODUCT_TOLERANCE_OF_THICKNESS,TOLERANCE_OF_COATING_THICKNESS,SALESMAN_USER_ID,SHOP_ID,QUOTATION_CREATED_LAT,QUOTATION_CREATED_LONG,QUOTATION_CREATED_ADDRESS,CREATED_BY,
									CREATED_DATE,REMARKS,DOCUMENT_NUMBER,QUOTATION_STATUS,SEL_QUOTATION_PDF_TEMPLATE,QUOTATION_CONTACT_PERSON,QUOTATION_CONTACT_NUMBER,QUOTATION_CONTACT_EMAIL,QUOTATION_CONTACT_DOA)
									SELECT @USER_ID,@QUOTATION_NUMBER,@QUOTATIONSAVE_DATE,@QUOTATION_DATE_SELECTION,@PROJECT_NAME,@TAXES,@FREIGHT,@DELIVERY_TIME,@PAYMENT,@VALIDITY,@BILLING,
	...
	ELSE IF @ACTION='QUOTATIONDOCUMENTNOLIST'
		BEGIN
			--Rev 4.0 && Some new fields added as SEL_QUOTATION_PDF_TEMPLATE,QUOTATION_CONTACT_PERSON,QUOTATION_CONTACT_NUMBER,QUOTATION_CONTACT_EMAIL,QUOTATION_CONTACT_DOA & sProducts_Description
			SELECT QH.QUOTATION_NUMBER AS quotation_number,CONVERT(NVARCHAR(10),QH.QUOTATIONSAVE_DATE,105)+' '+CONVERT(NVARCHAR(10),QH.QUOTATIONSAVE_DATE,108) AS save_date_time,
			CONVERT(NVARCHAR(10),QH.QUOTATION_DATE_SELECTION,105) AS quotation_date_selection,QH.PROJECT_NAME AS project_name,QH.TAXES AS taxes,QH.FREIGHT AS Freight,QH.DELIVERY_TIME AS delivery_time,
			QH.PAYMENT AS payment,QH.VALIDITY AS validity,QH.BILLING AS billing,QH.PRODUCT_TOLERANCE_OF_THICKNESS AS product_tolerance_of_thickness,QH.TOLERANCE_OF_COATING_THICKNESS AS tolerance_of_coating_thickness,
			QH.SALESMAN_USER_ID AS salesman_user_id,QH.SHOP_ID AS shop_id,MS.Shop_Name AS shop_name,MS.Shop_Owner_Contact AS shop_phone_no,QH.QUOTATION_CREATED_LAT AS quotation_created_lat,
			QH.QUOTATION_CREATED_LONG AS quotation_created_long,QH.QUOTATION_CREATED_ADDRESS AS quotation_created_address,MS.Address AS shop_addr,MS.Shop_Owner_Email AS shop_email,
			MS.Shop_Owner AS shop_owner_name,SM.salesman_name,SM.salesman_designation,SM.salesman_login_id,SM.salesman_email,SM.salesman_phone_no,QH.REMARKS AS Remarks,QH.DOCUMENT_NUMBER AS document_number,
			QH.SEL_QUOTATION_PDF_TEMPLATE AS sel_quotation_pdf_template,QH.QUOTATION_CONTACT_PERSON AS quotation_contact_person,QH.QUOTATION_CONTACT_NUMBER AS quotation_contact_number,
			QH.QUOTATION_CONTACT_EMAIL AS quotation_contact_email,QH.QUOTATION_CONTACT_DOA AS quotation_contact_doa,QHD.PROD_ID AS product_id,MP.sProducts_Name AS product_name,MP.sProducts_Description AS product_des,
			QHD.COLOR_ID AS color_id,MC.Color_Name AS color_name,QHD.RATE_SQFT AS rate_sqft,QHD.RATE_SQMTR AS rate_sqmtr,CAST(QHD.QTY AS int) AS qty,QHD.AMOUNT AS amount
			FROM FSMAPIQUOTATIONHEAD QH
