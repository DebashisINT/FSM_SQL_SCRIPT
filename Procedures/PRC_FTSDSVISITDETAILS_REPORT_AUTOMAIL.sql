...
5.0		v2.0.41		Debashis	19-07-2023		Unable to open DS Visit Details report of ITC.Now it has been care of.Refer: 0026595
												[Optimization required in DS Visit Details (Auto Mail). Refer: 26600]
****************************************************************************************************************************************************************************/
BEGIN
	SET NOCOUNT ON
	...
	-- Rev Sanchita [ table FTSDSVISITDETAILS_REPORT renamed to FTSDSVISITDETAILS_REPORT_AUTOMAIL]
	...
	SET @SqlStr+='SELECT USERID,MIN(DAYSTTIME) AS DAYSTTIME,MAX(DAYENDTIME) AS DAYENDTIME,STARTENDDATE,STARTENDDATEORDBY FROM('
	SET @SqlStr+='SELECT USERID,DAYSTTIME,DAYENDTIME,STARTENDDATE,STARTENDDATEORDBY FROM #TMPDAYSTARTEND '
